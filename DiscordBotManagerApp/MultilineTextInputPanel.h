...
/// </summary>
class MultilineTextInputPanel : public wxPanel
{
public:
    ...
    MultilineTextInputPanel(wxWindow* parent, wxWindowID id = wxID_ANY, const wxString& value = wxEmptyString,
        ...
        const wxString& dummyText = "!?dummyText");
    ...
    MultilineTextInput m_textInput;
protected:
    /// <summary>
    ...
    wxBitmap m_bitmap;
    wxBitmap m_bitmapHovered;
    wxBitmap m_bitmapClicked;
};
